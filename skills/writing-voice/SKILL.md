...
name: writing-voice
description: >-
  Write or rewrite content in a direct, personal, sensory style that feels
  human. Applies voice principles, bans AI-giveaway phrases, and enforces
  visual formatting rules. Use when writing blog posts, social media, website
  copy, emails, PR descriptions, commit messages, or any written content.
  Use when the user asks to write, rewrite, edit copy, review tone, or match
  their voice.
---
...
- [ ] **One idea**: Can you state the core message in one sentence?
- [ ] **Hook**: Does the opening line make you want to read line two?
- [ ] **Grandpa test**: Would someone outside your industry understand the hook?
- [ ] **No AI slop**: Zero banned phrases from the blacklist?
- [ ] **Earned words**: Does every sentence add meaning? Could you cut 20% more?
- [ ] **Scannable**: Is it visually easy to skim on mobile?
- [ ] **Sensory**: At least one tactile/vivid word that makes the reader *feel* something?
- [ ] **Singular reader**: Addressed to "you" (one person), not "users" or "people"?
- [ ] **Active voice**: No passive constructions slipped through?
- [ ] **Natural speech**: Read it aloud — does it sound like a person talking?
