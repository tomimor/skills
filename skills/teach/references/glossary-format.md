...
`GLOSSARY.md` is the canonical language for this teaching workspace. All lessons,
exercises, and learning records should adhere to its terminology. Building it is
itself part of learning: compressing a concept into a tight definition is
...
Systematically increasing the demand on a muscle over time -- via load, volume,
or intensity.
...
- **Add a term only when the user understands it.** The glossary records
  compressed knowledge, not a dictionary the user reads to learn. If a concept
  was just introduced, wait until they can use it correctly before promoting it.
- **Be opinionated.** When several words exist for one concept, pick the best and
  list the rest as aliases to avoid. This is how language compresses.
...
- **Revise as understanding deepens.** A definition written in week one may be
  wrong by week six. Update in place; don't leave stale entries.
