...
for lessons is drawn from here, not from parametric guesses. Wisdom comes from
the communities listed here.
...
- **Group by Knowledge / Wisdom.** Mirrors the philosophy in
  [../SKILL.md](../SKILL.md). A resource may appear in only one group.
- **Surface gaps explicitly.** If no good resource exists for an area the
  ...
  future search.
- **Prune ruthlessly.** A resource that turned out wrong, shallow, or off-mission
  should be removed, not buried. Five sharp sources beat thirty mediocre ones.
